...
link.setAttribute("href", "/records/delete")
...
td5.appendChild(link);*/
    ...
    let link2 = "/records/delete/"+data[i]._id

    //td5.innerHTML = "Delete"
    var linkText = 'Delete'
   // link.appendChild(linkText);
link.href="/records/delete/"+data[i]._id
...
$.ajax({
  dataType: 'json',
            ...
            type: 'POST',
            url: "/records/classesV/update/"+td.id,
...
link.className = "text-end";
    ...
    let link2 = "/records/delete/"+data._id

    //td5.innerHTML = "Delete"
    var linkText = 'Delete'
    // link.appendChild(linkText);
    link.href="/records/delete/"+data._id
    //td5.innerText = 'Delete'
    link.innerHTML='<a href="'+link2+'">'+linkText+'</a>'
